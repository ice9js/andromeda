...
export const isPostMediaLoading = (state, postSlug) => get(state, ['media', 'loading', postSlug]);

export const getPostImages = (state, postSlug) => get(state, ['media', 'items', postSlug]) || [];

export const getPostImage = (state, postSlug, imageId) =>
	find(getPostImages(state, postSlug), (image) => image.id === imageId);
