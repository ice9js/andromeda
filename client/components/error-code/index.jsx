...
const errors = {
	...
	[503]: {
		...
		message:
			`Fortunately, it's likely that at least some of this site's content is available to you, even offline.\n` +
...
const ErrorCode = ({ code }) => (
	<div className="error-code">
		<div className="error-code__header">{get(errors, [code, 'header'], defaultHeader)}</div>
